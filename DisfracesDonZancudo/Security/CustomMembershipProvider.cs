...
//using Clinker.TermoStat.Web.Models.Export.Page;
...
namespace DisfracesDonZancudo.Security
{
    public class CustomMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
			...
			/*
            EmpleadoMapper empleado = new EmpleadoMapper();
            var user = empleado.IsValid(username, password);*/
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
			...
			UserLogin empleado = new UserLogin();
		//	Core.SecurityCore core = new SecurityCore();
			var user = empleado;
